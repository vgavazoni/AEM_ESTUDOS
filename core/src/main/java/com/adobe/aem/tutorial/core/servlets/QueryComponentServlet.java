...
@SlingServletResourceTypes(
        ...
        selectors = "component-query-search",
        methods = HttpConstants.METHOD_POST)
@ServiceDescription("Simple Demo Servlet")
public class QueryComponentServlet extends SlingAllMethodsServlet {

    private static final Logger log = LoggerFactory.getLogger(QueryComponentServlet.class);
    ...
    protected void doPost(final SlingHttpServletRequest req,
        ...
        try {
            ...
            map.put("property.value", "practice/components/secondcomponent");
