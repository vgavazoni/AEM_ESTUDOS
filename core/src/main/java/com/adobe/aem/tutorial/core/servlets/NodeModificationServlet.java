...
public class NodeModificationServlet extends SlingAllMethodsServlet {
    ...
    private static final Logger log = LoggerFactory.getLogger(NodeModificationServlet.class);
    ...
    protected void doPost(final SlingHttpServletRequest req,
        ...
        try {
            ...
            log.error(" Error in getNode" + e.getMessage());
        ...
        resp.getWriter().write("Title from Post = " + resource.getValueMap().get(JcrConstants.JCR_TITLE));
    }
}
